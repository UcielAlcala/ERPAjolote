                ...
                items: [
                    {
                        label: 'Materiales',
                        icon: 'pi pi-fw pi-database',
                        routerLink: ['/datos-maestros/materiales']
                    },                    
                    {
                        label: 'Piezas Imprimibles',
                        icon: 'pi pi-fw pi-th-large',
                        routerLink: ['/datos-maestros/piezas-impresas']
                    },                    
                    {
                        label: 'Productos Finales',
                        icon: PrimeIcons.SHOPPING_BAG,
                        routerLink: ['/datos-maestros/productos-finales']
                    },                    
                ]
            },
            {
                ...
                items: [
                    {
                        label: 'Almacenes',
                        icon: 'pi pi-fw pi-user',
                        routerLink: ['/gestion-inventario/almacenes']
                    },                    
                    {
                        label: 'Inventario',
                        icon: 'pi pi-fw pi-file',
                        routerLink: ['/gestion-inventario/inventario']
                    },                    
                ]
            },
            {
